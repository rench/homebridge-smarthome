...
class CtrlNeutral1 extends Base {
  constructor(mijia) {
    super(mijia);
 ...
 */
  ...
  setSwitch(sid, channel) {
    let uuid = UUIDGen.generate('Mijia-CtrlNeutral1@' + sid);
    ...
    if (!accessory) {
      ...
      accessory.getService(Service.AccessoryInformation)
        ...
        .setCharacteristic(Characteristic.Model, "Mijia CtrlNeutral1")
    ...
    accessory.context.model = 'ctrl_neutral1';
    ...
    if (!setter || setter.length == 0) {
      service.getCharacteristic(Characteristic.On).on('set', (value, callback) => {
        ...
        let cmd = { cmd: 'write', model: 'ctrl_neutral1', sid: sid, data: JSON.stringify(data) };
